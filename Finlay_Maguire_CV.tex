...
\address{\bf HOME ADDRESS\\43 Blackboy Road\\Exeter\\EX4 6SZ\\+44 (0)77 6989 5717\\root@finlaymagui.re\\finlaymagui.re}
...
\begin{tabbing}
\hspace{2in}\= \hspace{2.6in}\= \kill
{\bf Gaussian Process Summer School 2015} \> \> 14-16th September 2015\\
\> \>University of Sheffield,  \\
\> \> Sheffield, United Kingdom\\
\end{tabbing}\vspace{-40pt}
Participant
...
\> \> MA, USA \\
\end{tabbing}\vspace{-40pt}
Participant on this competitive and internationally renowned course.
...
\item Several open source contributions to projects primarily involving python and C++ 
