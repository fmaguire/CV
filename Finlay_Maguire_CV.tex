...
\section{SHORT TERM PROJECTS}
   ...
   {\bf National Data Science Bowl} \> \>        December 2014 - March 2015\\
     \end{tabbing}\vspace{-20pt}      
     Participating in a Kaggle machine learning competition focussed on image classification of 121 classes of plankton. Formed part of 6-person team with PhD students from University of Edinburgh. Our strategy is to use a CUDA-accelerated convnet implemented in theano.
     Placed in top $\sim5\%$ of teams (57/1049) by model averaging several GPU-accelerated deep convolutional neural network models trained using highly online augmented images, conventional visual feature extraction and hierarchial label classification data.
