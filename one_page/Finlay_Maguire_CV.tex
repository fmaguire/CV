...
\href{mailto:finlay.maguire@dal.ca}{finlay.maguire@dal.ca} 
}
...
\runsubsection{/ Exeter University}\\
...
\descript{BA (hons) Natural Science (Biological Sciences)}
...
%jnucleic acid extraction \textbullet{} culturing \textbullet{}
...
\runsubsection{Dalhousie University}
\descript{| Assistant Professor}
\location{January 2022 – Present | Halifax, Nova Scotia}
    \vspace{0.2cm}
...
\runsubsection{Dalhousie University}
\descript{| Donald Hill Fellow}
\location{January 2019 - January 2022 | Halifax, Nova Scotia}
\begin{tightemize}
...
%\item Applied novel Bayesian optimisation methods to the problem of genome assembly.
...
\descript{| Competitive Machine Learning Team}
