...
\vspace{-0.1in}
 \begin{tabbing}
   ...
   \end{tabbing}\vspace{-20pt}  
Honours schools: Cellular and Developmental Biology and Biology of Plant and Animal Disease\\
...
\section{SHORT TERM PROJECTS}
   ...
   \hspace{2in}\= \hspace{2.6in}\= \kill 
    {\bf BBC Cloud Lab Documentary} \> \>        October 2013\\
     \end{tabbing}\vspace{-20pt}      
     Acted as NASA representative and scientific adviser for the British Broadcasting Company Cloud Lab documentary on atmospheric science. Prepared microbial sampling and exposure protocols and materials as well as advised on correct means to conduct these experiments.
...
\section{AWARDS AND GRANTS}
   ...
   Funded a research project with Dr. David J. Smith at NASA Kennedy Space Centre \\on bacterial adaptations to extreme conditions (\textsterling3500).
...
\item Familiarity with R, C++, linux sysadmin, statistics and machine learning
\item Some rudimentary knowledge of CSS, Verilog, Prolog, Go
\item Expert in bioinformatics areas: transcriptomics, molecular evolution/phylogenetics, genomics, metabolomics, sequence analysis, annotation
